...
namespace Summa.Wpf.Data
{
    ...
    /// <summary>
    /// Defines the base class for a <see cref="INotifyPropertyChanged"/> class.
    /// </summary>
    [Serializable]
    public abstract class NotifierBase : INotifyPropertyChanged
    {
        ...
        /// </summary>
        protected virtual void RaiseIndexer() => RaiseChanged("Item[]");

        /// <summary>
        /// Fires a new <see cref="PropertyChanged"/> event for the given property name.
        /// </summary>
        /// <param name="propertyName"> Changed property name. </param>
        protected virtual void RaiseChanged([CallerMemberName] string propertyName = null) => PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertyName));
        ...
        /// <param name="propertyName"> Changed property name. </param>
        protected virtual void RaiseChanged<T>(ref T propertyValue, T value, [CallerMemberName] string propertyName = null)
        {
